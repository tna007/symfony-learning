 ...
 */
final class Version20210517184709 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient AS SELECT id, name, amount FROM ingredient');
        ...
        $this->addSql('INSERT INTO ingredient (id, name, amount) SELECT id, name, amount FROM __temp__ingredient');
